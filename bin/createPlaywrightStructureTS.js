...
const repo = 'https://github.com/erenkorkmazemre/playwright-structure-ts';
...
async function setup() {
  try {
    ...
    console.log(useYarn ? '    yarn start:test:local:e2e:debug' : '    npm run start:test:local:e2e:debug');
    console.log();
    console.log('Enjoy !');
